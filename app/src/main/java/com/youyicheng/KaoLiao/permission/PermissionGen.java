package com.youyicheng.KaoLiao.permission;
...
import com.youyicheng.KaoLiao.permission.internal.Utils;
...
public class PermissionGen {
  ...
  private static void requestPermissions(Object object, int requestCode, String[] permissions){
    ...
    List<String> deniedPermissions = Utils.findDeniedPermissions(OrangeApp.mContext, permissions);
